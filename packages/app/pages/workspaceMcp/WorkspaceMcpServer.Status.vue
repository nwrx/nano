...
import FormStatus from '~/components/mcpServer/McpServerFormStatus.vue'

definePageMeta({
  name: 'WorkspaceMcpServerStatus',
  path: '/:workspace/pools/:pool/servers/:server/status',
  middleware: ['redirect-when-guest', 'abort-reserved'],
  layout: 'workspace-mcp',
  icon: 'i-carbon:container-runtime-monitor',
