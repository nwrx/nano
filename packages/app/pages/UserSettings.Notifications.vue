...
definePageMeta({
  ...
  description: {
    en: 'Manage your notification settings and preferences.',
    fr: 'Gérez vos paramètres et préférences de notification.',
    de: 'Verwalten Sie Ihre Benachrichtigungseinstellungen und -präferenzen.',
    es: 'Administre la configuración y preferencias de notificación.',
    zh: '管理您的通知设置和偏好。',
  },
})
...
const TableRow = createReusableTemplate<{ name: string }>()
const TableSection = createReusableTemplate<{ title: string; icon: string }>()
</script>
