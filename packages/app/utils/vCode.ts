...
const toCode: DirectiveHook<HTMLElement, any, string | undefined, Language> = (element, binding) => {
 ...
 * </template>
 */
export const vCode: Directive<HTMLElement, string | undefined, Language> = {
  updated: toCode,
  mounted: toCode,
}
