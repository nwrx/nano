...
useHead(() => {
  ...
  return {
    ...
    meta: [
      ...
      { name: 'application-name', content: i18n.t('title') },
      ...
      { name: 'twitter:site', content: i18n.t('title') },
      { name: 'twitter:title', content: i18n.t('title') },
      { name: 'twitter:description', content: i18n.t('description') },
...
en:
  title: Nanoworks
  description: A flow-based programming environment.
</i18n>
