...
export default defineNuxtConfig({
  ...
  vite: {
    optimizeDeps: {
      include: [
        '@unshared/vue/BaseAlerts',
        '@unshared/vue/BaseCollapse',
        '@unshared/vue/BaseInputList',
        '@unshared/vue/BaseInputToggle',
        '@unshared/vue/BaseInputText',
        '@unshared/vue/BaseInputFile',
        '@unshared/vue/BaseTable',
        '@unshared/vue/BaseDialog',
        '@unshared/string/toSlug',
        '@unshared/vue/useAlerts',
        '@unshared/vue/BaseMenu',
        '@unshared/vue/BaseBadge',
