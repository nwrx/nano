...
<template>
  <div>
    ...
    <EditorPanelFlowSettings />

    <!-- Variables -->
    <!--
      <EditorPanelSectionVariables
      v-model:is-open="isVariablesOpen"
      :variables="variables"
      :title="t('variable.title')"
      :text="t('variable.text')"
      :create-title="t('variable.create.title')"
      :create-text="t('variable.create.text')"
      :create-label="t('variable.create.label')"
      :update-title="t('variable.update.title')"
      :update-text="t('variable.update.text')"
    ...
    <!--
      <EditorPanelSectionVariables
      v-model:is-open="isSecretsOpen"
      :variables="secrets"
      :title="t('secret.title')"
      :text="t('secret.text')"
      :create-title="t('secret.create.title')"
      :create-text="t('secret.create.text')"
      :create-label="t('secret.create.label')"
      :update-title="t('secret.update.title')"
      :update-text="t('secret.update.text')"
