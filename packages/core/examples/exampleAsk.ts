...
async function main() {
  const thread = createThreadFromFlow({
    ...
    nodes: {
      ...
      openai: {
        component: 'openai',
        token: 'sk-proj-Vxe7VBNBYUyQ5Pd7uLluT3BlbkFJZrzuRRExqODu8kYiwkHn',
        modelId: 'gpt-3.5-turbo',
      },
      // groq: {
      //   component: 'groq',
      //   model: 'llama3-8b-8192',
      //   token: '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',
      // },
      // mistralai: {
      //   component: 'mistralai',
      //   model: 'mistral-large-latest',
      //   token: '39oPZ4z2QnuvxfWhyunnuxVXN8S9ztmY',
      // },
      execute: {
        component: 'execute',
      },
      anthropic: {
        ...
        token: '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',
      },
      inference: {
        component: 'inference',
