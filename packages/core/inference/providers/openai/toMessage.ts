...
export function toMessage(message: TextGeneration.Message): ChatCompletionMessageParam | undefined {
...
function convertAssistantContent(content: TextGeneration.MessageAssistantContent[]): string | undefined {
...
function getToolCalls(content: TextGeneration.MessageAssistantContent[]): ChatCompletionMessageToolCall[] {
...
function convertToolResultContent(toolResult: TextGeneration.ContentToolResult): string {
